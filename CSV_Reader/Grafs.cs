...
{
    class GrafTemperature : GrafPage
    {
        public GrafTemperature(string yAxesName, string unit, double maxValue) : base(yAxesName, unit, maxValue)
        {            
        }

        protected override void SetSeries()
        {
            base.arSeries = new GrafSeries[]
            {
    ...
    class GrafPressure : GrafPage
    {        
        public GrafPressure(string yAxesName, string unit, double maxValue) : base(yAxesName, unit, maxValue)
        {            
        }
        protected override void SetSeries()
        {
    ...
    class GrafConductivity : GrafPage
    {
        public GrafConductivity(string yAxesName, string unit, double maxValue) : base(yAxesName, unit, maxValue)
        {
        }
        protected override void SetSeries()
        {
